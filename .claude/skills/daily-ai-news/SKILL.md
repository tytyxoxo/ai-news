...
## ขั้นตอนที่ 3 — รูปแบบไฟล์และข้อความ LINE

ใช้รูปแบบนี้เท่านั้น ทั้งในไฟล์ GitHub และข้อความที่ส่งไป LINE

1. {หัวข้อข่าว}
   บทความ: {วิเคราะห์เนื้อหา 5-8 ประโยค}
   🔗 {url}
...
และในไฟล์ GitHub ให้ใช้รูปแบบ Markdown
